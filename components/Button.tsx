...
const Button: React.FC<ButtonProps> = ({
  ...
  const variantStyles = {
    primary: "bg-red-800 text-white hover:bg-red-700 focus:ring-red-500", // Changed from slate to red
    secondary: "bg-gray-600 text-gray-200 hover:bg-gray-500 focus:ring-gray-400",
    danger: "bg-red-600 text-white hover:bg-red-700 focus:ring-red-500", // Danger red is slightly lighter than primary maroon
    outline: "bg-transparent text-gray-300 border border-gray-600 hover:bg-gray-700 hover:text-white focus:ring-red-500", // Updated focus ring
  };
