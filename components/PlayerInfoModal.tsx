    ...
    >
      <div className="bg-gray-800 p-6 sm:p-8 rounded-xl shadow-2xl w-full max-w-md border border-gray-700 text-gray-200">
        <div className="flex justify-between items-center mb-6">
          <h2 id="player-info-modal-title" className="text-xl sm:text-2xl font-bold text-gray-50 truncate" title={displayName}>
            {displayName}
          </h2>
          <button
            onClick={onClose}
        ...
        {isLoading ? (
          ...
          <div className="space-y-4">
            <div className="flex flex-col items-center space-y-3">
              ...
              />
              <p className="text-lg font-semibold text-gray-100">{playerProfile.username}</p>
            </div>
            ...
            <div className="border-t border-gray-700 pt-4 grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-1">
              ...
              <DetailItem label="Batting Style" value={playerProfile.batting_style} icon={<ShieldCheckIcon className="transform scale-x-[-1]" />} /> {/* Simple bat icon placeholder */}
              <DetailItem label="Bowling Style" value={playerProfile.bowling_style} icon={<ShieldCheckIcon />} /> {/* Simple ball icon placeholder */}
            </div>
